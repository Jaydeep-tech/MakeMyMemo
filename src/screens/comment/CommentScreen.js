 ...
 */
 ...
 import * as commentActions from "../../components/comment/ExampleActions";
 ...
 export default class ExampleComments extends Component {
   ...
   extractImage(c) {
     try 
     {
       return c.image_id && c.user.image_id !== "" ? c.user.image_id : "https://i.ibb.co/0FhKxS7/no-user.png";
     } 
     catch (e) 
     {
     //  console.log(e);
